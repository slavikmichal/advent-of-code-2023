...
object Hello {
    ...
    object Rules {
        val cardValues = List("2", "3", "4", "5", "6", "7", "8", "9", "T", "J", "Q", "K", "A")
    }
    ...
    def main(args: Array[String]) = {
        ...
        var result: Long = 0
        val sorted = hands.sortBy(hand => (getHandRank(hand.kinds), getCardRank(hand.cards(0)), getCardRank(hand.cards(1)), getCardRank(hand.cards(2)), getCardRank(hand.cards(3)), getCardRank(hand.cards(4))))
